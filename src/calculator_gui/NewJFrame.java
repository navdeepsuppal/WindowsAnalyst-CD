...
int op;
    ...
    private void initComponents() {
        ...
        jButton24.setFont(new java.awt.Font("Comic Sans MS", 0, 24)); // NOI18N
        jButton24.setText(".");
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jButton13, jButton14});
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jButton13, jButton14});

        jButton17.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jButton17.setText("Cube");
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jButton15, jButton16, jButton17, jButton18, jButton22});
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jButton15, jButton16, jButton17, jButton18, jButton22});
        ...
        jRadioButton1.setFont(new java.awt.Font("Comic Sans MS", 1, 10)); // NOI18N
        ...
        jRadioButton2.setFont(new java.awt.Font("Comic Sans MS", 1, 10)); // NOI18N
        ...
        jButton23.setBackground(new java.awt.Color(0, 170, 153));
        jButton23.setFont(new java.awt.Font("Sitka Banner", 1, 25)); // NOI18N
        jButton23.setText("=");
        ...
        jTextField2.setFont(new java.awt.Font("Comic Sans MS", 0, 10)); // NOI18N
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        // TODO add your handling code here:
         String magic = jTextField1.getText();
       String jj="0000";
      ...
      {
          this.dispose();
           password_manager info1 = new password_manager();
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        ...
        double sq1;
        double sq2;
        sq1=Double.parseDouble(jTextField1.getText());
        sq2=sq1*sq1;
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        ...
        int m = 0;
        int i = 0;
        sqrt = Double.parseDouble(jTextField1.getText()); 
        for(i=1;i<=sqrt-1;i++)
        {
            if(i*i==sqrt)
            {
        ...
        if (m!=0)
        {
            ...
            jTextField1.setText("Can't Find");
        }
    ...
    private void jButton22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton22ActionPerformed
        ...
        int j;
        double pnumber;
        pnumber=Double.parseDouble(jTextField1.getText());
                ...
                if(flag==0)
                        {
                            jTextField1.setText("It's Prime Number"); 
                           
                        }
                else {
                            jTextField1.setText("It's Not A Prime Number"); 
